...
export async function sendRegistrationEmail(email: string, name: string): Promise<boolean> {
  ...
  const text = `
    ...
    Thank you for registering with ExpenseTracker Made By Ajay Farenziya! 
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #1a73e8;">ExpenseTracker Made By Ajay Farenziya</h2>
      <p>Hello ${name},</p>
      <p>Thank you for registering with <strong>ExpenseTracker Made By Ajay Farenziya</strong>!</p>
...
export async function sendApprovalEmail(email: string, name: string): Promise<boolean> {
  const subject = 'Account Approved - ExpenseTracker Made By Ajay Farenziya';
  const text = `
    Hello ${name},
    
    Your account for ExpenseTracker Made By Ajay Farenziya has been approved! 
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #1a73e8;">ExpenseTracker Made By Ajay Farenziya</h2>
      <p>Hello ${name},</p>
      <p>Your account for <strong>ExpenseTracker Made By Ajay Farenziya</strong> has been <span style="color: #0f9d58; font-weight: bold;">approved</span>!</p>
...
export async function sendRejectionEmail(email: string, name: string): Promise<boolean> {
  const subject = 'Account Registration Status - ExpenseTracker Made By Ajay Farenziya';
  const text = `
    Hello ${name},
    
    We regret to inform you that your account registration for ExpenseTracker Made By Ajay Farenziya has been rejected.
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #1a73e8;">ExpenseTracker Made By Ajay Farenziya</h2>
      <p>Hello ${name},</p>
      <p>We regret to inform you that your account registration for <strong>ExpenseTracker Made By Ajay Farenziya</strong> has been <span style="color: #d93025; font-weight: bold;">rejected</span>.</p>
...
export async function sendPasswordResetEmail(email: string, name: string, resetLink: string): Promise<boolean> {
  const subject = 'Password Reset - ExpenseTracker Made By Ajay Farenziya';
  const text = `
    Hello ${name},
    
    You have requested to reset your password for ExpenseTracker Made By Ajay Farenziya.
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #1a73e8;">ExpenseTracker Made By Ajay Farenziya</h2>
      <p>Hello ${name},</p>
      <p>You have requested to reset your password for <strong>ExpenseTracker Made By Ajay Farenziya</strong>.</p>
