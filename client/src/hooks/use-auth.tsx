...
import { insertUserSchema, userLoginSchema, User as SelectUser, InsertUser, UserLogin } from "@shared/schema";
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const loginMutation = useMutation<SelectUser, Error, UserLogin>({
